...
the tools using the usual ampersand notation –
[`tmux_tool_info()`](https://AnswerDotAI.github.io/dialoghelper/tmux.html#tmux_tool_info)
will add a note with the full list for you:
...
<a
href="https://github.com/AnswerDotAI/dialoghelper/blob/main/dialoghelper/tmux.py#L26"
target="_blank" style="float:right; font-size:smaller">source</a>

### shell_ret

>  shell_ret (cmd, capture_output=True, text=True, ret=True, host:str=None,
>                 ip:str=None, user:str=None, keyfile:str=None)
...
<td>str</td>
<td>None</td>
<td>Optional SSH Host</td>
</tr>
<tr>
<td>ip</td>
<td>str</td>
<td>None</td>
<td>Optional SSH IP</td>
</tr>
<tr>
<td>user</td>
<td>str</td>
<td>None</td>
<td>Optional SSH user</td>
</tr>
<tr>
<td>keyfile</td>
<td>str</td>
<td>None</td>
<td>Optional SSH keyfile</td>
</tr>
</tbody>
</table>
...
<a
href="https://github.com/AnswerDotAI/dialoghelper/blob/main/dialoghelper/tmux.py#L37"
target="_blank" style="float:right; font-size:smaller">source</a>

### set_default_history

>  set_default_history (n:int)
...
>  pane (n:int=None, pane:int=None, session:str=None, window:int=None,
>            capture_output=True, text=True, ret=True, host:str=None,
>            ip:str=None, user:str=None, keyfile:str=None)
...
<td>int</td>
<td>None</td>
<td>Number of scrollback lines to capture, in addition to visible area
(None uses default_tmux_lines, which is 500 if not otherwise set)</td>
</tr>
<tr>
<td>pane</td>
<td>int</td>
<td>None</td>
<td>Pane number to capture from</td>
</tr>
<tr>
<td>session</td>
<td>str</td>
<td>None</td>
<td>Session name to target</td>
</tr>
<tr>
<td>window</td>
<td>int</td>
<td>None</td>
<td>Window number to target</td>
</tr>
<tr>
<td>capture_output</td>
<td>bool</td>
...
<a
href="https://github.com/AnswerDotAI/dialoghelper/blob/main/dialoghelper/tmux.py#L62"
target="_blank" style="float:right; font-size:smaller">source</a>

### list_panes

>  list_panes (session:str=None, window:int=None, capture_output=True,
>                  text=True, ret=True, host:str=None, ip:str=None,
>                  user:str=None, keyfile:str=None)
...
<td>str</td>
<td>None</td>
<td>Session name to list panes from</td>
</tr>
<tr>
<td>window</td>
<td>int</td>
<td>None</td>
<td>Window number to list panes from</td>
</tr>
<tr>
<td>capture_output</td>
<td>bool</td>
...
<a
href="https://github.com/AnswerDotAI/dialoghelper/blob/main/dialoghelper/tmux.py#L80"
target="_blank" style="float:right; font-size:smaller">source</a>

### panes

>  panes (session:str=None, window:int=None, n:int=None,
>             capture_output=True, text=True, ret=True, host:str=None,
>             ip:str=None, user:str=None, keyfile:str=None)
...
<td>int</td>
<td>None</td>
<td>Number of scrollback lines to capture</td>
</tr>
<tr>
<td>capture_output</td>
<td>bool</td>
...
<a
href="https://github.com/AnswerDotAI/dialoghelper/blob/main/dialoghelper/tmux.py#L93"
target="_blank" style="float:right; font-size:smaller">source</a>

### list_windows

>  list_windows (session:str=None, capture_output=True, text=True, ret=True,
>                    host:str=None, ip:str=None, user:str=None,
>                    keyfile:str=None)
...
<td>str</td>
<td>None</td>
<td>Session name to list windows from</td>
</tr>
<tr>
<td>capture_output</td>
<td>bool</td>
...
<a
href="https://github.com/AnswerDotAI/dialoghelper/blob/main/dialoghelper/tmux.py#L110"
target="_blank" style="float:right; font-size:smaller">source</a>

### windows

>  windows (session:str=None, n:int=None, capture_output=True, text=True,
>               ret=True, host:str=None, ip:str=None, user:str=None,
>               keyfile:str=None)
...
<a
href="https://github.com/AnswerDotAI/dialoghelper/blob/main/dialoghelper/tmux.py#L121"
target="_blank" style="float:right; font-size:smaller">source</a>

### list_sessions

>  list_sessions (capture_output=True, text=True, ret=True, host:str=None,
>                     ip:str=None, user:str=None, keyfile:str=None)
...
<a
href="https://github.com/AnswerDotAI/dialoghelper/blob/main/dialoghelper/tmux.py#L132"
target="_blank" style="float:right; font-size:smaller">source</a>

### sessions

>  sessions (n:int=None, capture_output=True, text=True, ret=True,
>                host:str=None, ip:str=None, user:str=None, keyfile:str=None)
...
<a
href="https://github.com/AnswerDotAI/dialoghelper/blob/main/dialoghelper/tmux.py#L141"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/AnswerDotAI/dialoghelper/blob/main/dialoghelper/tmux.py#L151"
target="_blank" style="float:right; font-size:smaller">source</a>
...
dialoghelper.tmux tools:
&`[pane, list_panes, panes, list_windows, windows, list_sessions, sessions]`
