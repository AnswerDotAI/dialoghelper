...
# %% auto #0
__all__ = ['importmodule', 'SymbolNotFound', 'resolve', 'symsrc', 'showsrc', 'symtype', 'symval', 'symtype_val', 'symdir',
           'symnth', 'symlen', 'symslice', 'symsearch', 'symset', 'run_code_interactive', 'tracetool', 'fmt_trace',
           'inspect_tool_info']

# %% ../nbs/02_inspecttools.ipynb #5ae7ad05
import inspect, re, sys, ast, builtins, os, linecache
from importlib import import_module
from . import add_msg

# %% ../nbs/02_inspecttools.ipynb #9778fca8
...
# %% ../nbs/02_inspecttools.ipynb #7fd415fa
def importmodule(
...
# %% ../nbs/02_inspecttools.ipynb #e40f68c9
...
# %% ../nbs/02_inspecttools.ipynb #659bf879
...
# %% ../nbs/02_inspecttools.ipynb #cee0fc8c
def symsrc(
...
# %% ../nbs/02_inspecttools.ipynb #ef12c6ca
def showsrc(
    sym: str  # Dotted symbol path (e.g `Interval` or `sympy.sets.sets.Interval`) or "_last" for previous result
):
...
# %% ../nbs/02_inspecttools.ipynb #bbf67405
def symtype(
...
# %% ../nbs/02_inspecttools.ipynb #dd4279b8
def symval(
...
# %% ../nbs/02_inspecttools.ipynb #3cb05b78
def symtype_val(
    syms: str  # Comma separated str list of dotted symbol paths (e.g `Interval` or `sympy.sets.sets.Interval`); "_last" for prev result
):
    ...
    - `symval("a,c,notexist")` -> `[(<class 'str'>,'foo'),(<class 'int'>,1), 'SymbolNotFound']`"""
    def f(o):
        try: r = resolve(o)
        except SymbolNotFound as e: return 'SymbolNotFound'
...
# %% ../nbs/02_inspecttools.ipynb #1cd34596
def symdir(
    sym: str,  # Dotted symbol path (e.g `Interval` or `sympy.sets.sets.Interval`) or "_last" for previous result
...
# %% ../nbs/02_inspecttools.ipynb #9542de0b
def symnth(
...
# %% ../nbs/02_inspecttools.ipynb #4ac6ca2d
def symlen(
...
# %% ../nbs/02_inspecttools.ipynb #a5dfbe8f
def symslice(
    sym: str,   # Dotted symbol path or "_last" for previous result
...
# %% ../nbs/02_inspecttools.ipynb #5fca4d70
def symsearch(
    sym:str,      # Dotted symbol path or "_last" for previous result
...
# %% ../nbs/02_inspecttools.ipynb #02c09e1a
def symset(
...
# %% ../nbs/02_inspecttools.ipynb #a8e90aa9
...
# %% ../nbs/02_inspecttools.ipynb #a1a11745
...
# %% ../nbs/02_inspecttools.ipynb #ba9f1666
def tracetool(
...
# %% ../nbs/02_inspecttools.ipynb #7c97567d
...
# %% ../nbs/02_inspecttools.ipynb #78c24a04
