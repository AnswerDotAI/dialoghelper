...
# %% auto #0
__all__ = ['dname_doc', 'md_cls_d', 'all_builtins', 'run_python', 'dh_settings', 'Placements', 'mermaid_url', 'besure_doc',
           'add_styles', 'RunPython', 'find_var', 'set_var', 'find_dname', 'find_msg_id', 'call_endp', 'curr_dialog',
           'msg_idx', 'add_scr', 'iife', 'pop_data', 'fire_event', 'event_get', 'display_response', 'read_msg',
           'find_msgs', 'view_dlg', 'add_html', 'read_msgid', 'add_msg', 'del_msg', 'update_msg', 'run_msg', 'copy_msg',
           'paste_msg', 'enable_mermaid', 'mermaid', 'toggle_header', 'url2note', 'create_dialog', 'rm_dialog',
           'run_code_interactive', 'dialog_link', 'msg_insert_line', 'msg_str_replace', 'msg_strs_replace',
           'msg_replace_lines', 'msg_del_lines', 'dialoghelper_explain_dialog_editing', 'ast_py', 'ast_grep',
...
import json,importlib,linecache,re,inspect,uuid,ast
...
# %% ../nbs/00_core.ipynb #ade322da
run_python = RunPython()
__llmtools__.add('run_python')
...
def _msg_edit(success_tpl):
    def decorator(fn):
        def wrapper(id:str, *args, update_output:bool=False, dname:str='', log_changed:bool=False, **kw):
