...
# %% auto #0
__all__ = ['dname_doc', 'md_cls_d', 'dh_settings', 'pyrun', 'Placements', 'mermaid_url', 'besure_doc', 'add_styles', 'find_var',
           'set_var', 'find_dname', 'xposta', 'xgeta', 'call_endp', 'call_endpa', 'curr_dialog', 'msg_idx',
           'add_html_a', 'add_html', 'add_scr_a', 'add_scr', 'iife_a', 'iife', 'pop_data_a', 'pop_data', 'fire_event_a',
           'fire_event', 'event_get_a', 'event_get', 'trigger_now', 'display_response', 'docs', 'read_msg', 'find_msgs',
           ...
           'url2note', 'create_or_run_dialog', 'stop_dialog', 'rm_dialog', 'run_code_interactive', 'dialog_link',
           'msg_insert_line', 'msg_str_replace', 'msg_strs_replace', 'msg_replace_lines', 'msg_del_lines', 'ast_py',
