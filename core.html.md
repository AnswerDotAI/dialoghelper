...
<a
href="https://github.com/AnswerDotAI/dialoghelper/blob/main/dialoghelper/core.py#L101"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/AnswerDotAI/dialoghelper/blob/main/dialoghelper/core.py#L258"
target="_blank" style="float:right; font-size:smaller">source</a>
...
>                ai_img:bool=True, split_re:str='(?=^#{1,6} .+)')
...
<td>str</td>
<td>(?=^#{1,6} .+)</td>
<td>Regex to split content into multiple notes, set to False for single
note</td>
</tr>
</tbody>
</table>
...
```
    ...
    [("xpost(url, data={'data_id': idx, 'timeout': timeout})",
      {'B': {'text': "{'data_id': idx, 'timeout': timeout}",
        'range': {'byteOffset': {'start': 4554, 'end': 4590},
         'start': {'line': 122, 'column': 36},
         'end': {'line': 122, 'column': 72}}},
       'A': {'text': 'url',
        'range': {'byteOffset': {'start': 4544, 'end': 4547},
...
```
    ...
    {'success': 'Inserted text after line 5 in message _31148b9b'}
...
```
    ...
    {'success': 'Replaced text in message _31148b9b'}
...
```
    ...
    {'success': 'Successfully replaced all the strings in message _31148b9b'}
...
```
    ...
    {'success': 'Replaced lines 2 to 4 in message _31148b9b'}
...
```
    ...
    {'success': 'Deleted lines 2 to 4 in message _31148b9b'}
...
<a
href="https://github.com/AnswerDotAI/dialoghelper/blob/main/dialoghelper/core.py#L416"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/AnswerDotAI/dialoghelper/blob/main/dialoghelper/core.py#L450"
target="_blank" style="float:right; font-size:smaller">source</a>
