...
<a
href="https://github.com/AnswerDotAI/dialoghelper/blob/main/dialoghelper/core.py#L215"
target="_blank" style="float:right; font-size:smaller">source</a>
...
```
    ...
    {'success': 'Inserted text after line 5 in message _84b2f8cd'}
...
```
    ...
    {'success': 'Replaced text in message _84b2f8cd'}
...
```
    ...
    {'success': 'Successfully replaced all the strings in message _84b2f8cd'}
...
```
    ...
    {'success': 'Replaced lines 2 to 4 in message _84b2f8cd'}
...
<a
href="https://github.com/AnswerDotAI/dialoghelper/blob/main/dialoghelper/core.py#L339"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/AnswerDotAI/dialoghelper/blob/main/dialoghelper/core.py#L345"
target="_blank" style="float:right; font-size:smaller">source</a>
