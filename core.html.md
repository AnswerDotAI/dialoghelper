...
<a
href="https://github.com/AnswerDotAI/dialoghelper/blob/main/dialoghelper/core.py#L85"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/AnswerDotAI/dialoghelper/blob/main/dialoghelper/core.py#L73"
target="_blank" style="float:right; font-size:smaller">source</a>
...
def add_scr(
    scr, oob:str='beforeend:#js-script'
):
...
<a
href="https://github.com/AnswerDotAI/dialoghelper/blob/main/dialoghelper/core.py#L158"
target="_blank" style="float:right; font-size:smaller">source</a>
...
```
    ...
    [{'id': '_8ce548d6', 'is_exported': 0, 'content': '1+1', 'output': '', 'msg_type': 'code'}, {'id': '_44cb1b2a', 'is_exported': 0, 'content': "_id = _add_msg_unsafe('1+1', run=True, msg_type='code')", 'output': '', 'msg_type': 'code'}, {'id': '_6e354677', 'is_exported': 0, 'content': '1+1', 'output': '', 'msg_type': 'code'}]
...
``` html
<msgs><code id="_955b9784">     1 │ #| default_exp core</code><code id="_a982e24d">     1 │ from dialoghelper import *</code><note id="_0aafe008">     1 │ # dialoghelper</note><code id="_e881cda4" export>     1 │ import json,importlib,linecache,re,inspect,uuid
     2 │ from typing import Dict
     3 │ from tempfile import TemporaryDirectory
     4 │ from ipykernel_helper import *
     5 │ from dataclasses import dataclass
     6 │ from os.path import normpath
     7 │ from fastcore.xml import to
```
...
<a
href="https://github.com/AnswerDotAI/dialoghelper/blob/main/dialoghelper/core.py#L241"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/AnswerDotAI/dialoghelper/blob/main/dialoghelper/core.py#L327"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/AnswerDotAI/dialoghelper/blob/main/dialoghelper/core.py#L372"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/AnswerDotAI/dialoghelper/blob/main/dialoghelper/core.py#L377"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/AnswerDotAI/dialoghelper/blob/main/dialoghelper/core.py#L400"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/AnswerDotAI/dialoghelper/blob/main/dialoghelper/core.py#L430"
target="_blank" style="float:right; font-size:smaller">source</a>
...
def ctx_folder(
    ...
    func:callable=<function join at 0x7fc072718cc0>, # function to apply to each matched file
...
<a
href="https://github.com/AnswerDotAI/dialoghelper/blob/main/dialoghelper/core.py#L446"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/AnswerDotAI/dialoghelper/blob/main/dialoghelper/core.py#L468"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/AnswerDotAI/dialoghelper/blob/main/dialoghelper/core.py#L476"
target="_blank" style="float:right; font-size:smaller">source</a>
...
```
    ...
    {'success': 'Inserted text after line 5 in message _3fbd42e2'}
...
```
    ...
    {'success': 'Replaced text in message _3fbd42e2'}
...
<a
href="https://github.com/AnswerDotAI/dialoghelper/blob/main/dialoghelper/core.py#L515"
target="_blank" style="float:right; font-size:smaller">source</a>
...
```
    ...
    {'success': 'Successfully replaced all the strings in message _3fbd42e2'}
...
<a
href="https://github.com/AnswerDotAI/dialoghelper/blob/main/dialoghelper/core.py#L545"
target="_blank" style="float:right; font-size:smaller">source</a>
...
```
    ...
    {'success': 'Replaced lines 2 to 4 in message _3fbd42e2'}
...
<a
href="https://github.com/AnswerDotAI/dialoghelper/blob/main/dialoghelper/core.py#L566"
target="_blank" style="float:right; font-size:smaller">source</a>
...
```
    ...
    {'success': 'Deleted lines 2 to 4 in message _3fbd42e2'}
...
<a
href="https://github.com/AnswerDotAI/dialoghelper/blob/main/dialoghelper/core.py#L584"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/AnswerDotAI/dialoghelper/blob/main/dialoghelper/core.py#L592"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/AnswerDotAI/dialoghelper/blob/main/dialoghelper/core.py#L598"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/AnswerDotAI/dialoghelper/blob/main/dialoghelper/core.py#L616"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/AnswerDotAI/dialoghelper/blob/main/dialoghelper/core.py#L622"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/AnswerDotAI/dialoghelper/blob/main/dialoghelper/core.py#L650"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/AnswerDotAI/dialoghelper/blob/main/dialoghelper/core.py#L655"
target="_blank" style="float:right; font-size:smaller">source</a>
