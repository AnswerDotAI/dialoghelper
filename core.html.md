...
```
    ...
    [{'id': '_8ce548d6', 'is_exported': 0, 'content': '1+1', 'output': '', 'msg_type': 'code'}, {'id': '_44cb1b2a', 'is_exported': 0, 'content': "_id = _add_msg_unsafe('1+1', run=True, msg_type='code')", 'output': '', 'msg_type': 'code'}, {'id': '_6e354677', 'is_exported': 0, 'content': '1+1', 'output': '2', 'msg_type': 'code'}]
...
``` html
<msgs><code id="_8ce548d6"><source>1+1<out>2</out></code><code id="_44cb1b2a">_id = _add_msg_unsafe('1+1', run=True, msg_type='code')</code><code id="_6e354677"><source>1+1<out>2</out></code></msgs>
```
...
<a
href="https://github.com/AnswerDotAI/dialoghelper/blob/main/dialoghelper/core.py#L273"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/AnswerDotAI/dialoghelper/blob/main/dialoghelper/core.py#L363"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/AnswerDotAI/dialoghelper/blob/main/dialoghelper/core.py#L382"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/AnswerDotAI/dialoghelper/blob/main/dialoghelper/core.py#L488"
target="_blank" style="float:right; font-size:smaller">source</a>
...
```
    ...
    {'success': 'Inserted text after line 5 in message _828d8235'}
...
```
    ...
    {'success': 'Replaced text in message _828d8235'}
...
<a
href="https://github.com/AnswerDotAI/dialoghelper/blob/main/dialoghelper/core.py#L520"
target="_blank" style="float:right; font-size:smaller">source</a>
...
```
    ...
    {'success': 'Successfully replaced all the strings in message _828d8235'}
...
```
    ...
    {'success': 'Replaced lines 2 to 4 in message _828d8235'}
...
<a
href="https://github.com/AnswerDotAI/dialoghelper/blob/main/dialoghelper/core.py#L571"
target="_blank" style="float:right; font-size:smaller">source</a>
...
```
    ...
    {'success': 'Deleted lines 2 to 4 in message _828d8235'}
...
<a
href="https://github.com/AnswerDotAI/dialoghelper/blob/main/dialoghelper/core.py#L597"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/AnswerDotAI/dialoghelper/blob/main/dialoghelper/core.py#L621"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/AnswerDotAI/dialoghelper/blob/main/dialoghelper/core.py#L631"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/AnswerDotAI/dialoghelper/blob/main/dialoghelper/core.py#L666"
target="_blank" style="float:right; font-size:smaller">source</a>
